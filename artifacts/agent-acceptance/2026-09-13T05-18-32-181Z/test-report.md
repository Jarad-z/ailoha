...
- 总体结果：**passed**
- 开始时间：2026-09-13T05:18:32.181Z
- 结束时间：2026-09-13T05:18:55.171Z
...
|---|---|---:|---:|---:|---|
| 01-typecheck | TypeScript 静态检查 | passed | 0 | 1.13s | [01-typecheck.log](./01-typecheck.log) |
| 02-build | 全 workspace 构建 | passed | 0 | 2.96s | [02-build.log](./02-build.log) |
| 03-regression | 全量确定性回归与 E2E | passed | 0 | 12.28s | [03-regression.log](./03-regression.log) |
| 04-live-http-e2e | 真实 DeepSeek HTTP 黑盒 E2E | passed | 0 | 6.62s | [04-live-http-e2e.log](./04-live-http-e2e.log) |
...
- `01-typecheck.log`、`02-build.log`、`03-regression.log`、`04-live-http-e2e.log`：原始执行日志。
